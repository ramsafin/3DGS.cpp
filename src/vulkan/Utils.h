...
template <uint32_t N> inline std::vector<float> zipAndFlattenVectors(std::array<std::vector<float>, 48> arrays) {
...
class BarrierBuilder {
  public:
    ...
    void build(vk::CommandBuffer commandBuffer, vk::PipelineStageFlags srcStageMask,
               vk::PipelineStageFlags dstStageMask) const;
